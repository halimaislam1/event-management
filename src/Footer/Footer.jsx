...
const Footer = () => {
    return (
        <div className='mb-1 '>
            <footer className="footer p-10 bg-black  md:ml-4  text-white ">
                    <nav className='ml-28'>
                    ...
                    <nav className='ml-28'>
                        ...
                        <p className="link link-hover flex items-center gap-2">
                            ...
                            <span>Contact : +8801234563467</span>
                        </p>
                        <p className="link link-hover flex items-center gap-2">
                            <HiOutlineMail></HiOutlineMail>
                            <span>Email: Event@Manegement.com</span>
                        </p>

                    </nav>
                    <nav className='ml-28 md:ml-20 '>
